...
<form action="resultid.shop" method="post" name="idform">
<!--    -->
<div class="limiter">
...
<li class="nav-item"><a class="nav-link" id="place-tab"
								...
								aria-selected="false"> <font size="10px" color="skyblue">SEARCH ID</font></a></li>
</ul>	
				...
				<div class="container-login100-form-btn m-t-17">
					<button class="login100-form-btn" onclick="idform.submit();">
					SEARCH ID
					</button>
