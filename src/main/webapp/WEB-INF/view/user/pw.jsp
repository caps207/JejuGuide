...
<body>
	<form action="changepw.shop" method="post">
				...
				<div class="wrap-login100 p-t-50 p-b-90">
					...
					<ul class="nav nav-tabs" id="myTab" role="tablist">
						<li class="nav-item"><a class="nav-link" id="place-tab"
							...
							aria-selected="false"> <font size="10px" color="skyblue">CHANGE
									PW</font></a></li>
					</ul>

					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="pw1" placeholder="New Password">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-16">
						<input class="input100" type="text" name="pw2" placeholder="Chack Password">
						<span class="focus-input100"></span>
					</div>
