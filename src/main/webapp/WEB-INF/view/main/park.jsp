...
<header class="main_menu">
	...
	<div class="container">
		<div style="padding-left: 50px;">
			...
			<div id="map" style="width: 59%; height: 600px; float: left;"></div>
			<div id="park" style="width: 39%; float: right;"></div>
		</div>
	</div>
...
<br><br><br><br><br><br><br><br><br><br><br>
	...
	$.ajax({
		...
		success: function(data){
			$(data).find("Row").each(function(){
				...
				title.push($(this).find("주차장명").text());
    ...
    mapOption = { 
        center: new kakao.maps.LatLng(33.49675309, 126.5329999), // 지도의 중심좌표
        level: 7 // 지도의 확대 레벨
    };
	...
	$.ajax({
		...
		success: function(data){
			$(data).find("Row").each(function(){
				...
				$("#head").empty();
				var head = "";
				head += "<h1><b>" + $(this).find("주차장명").text() +"</b></h1><br>";	
				var info = "";
				...
				info += "<tbody>";
				info += "<tr><th>주차장구분 </th><td>" + $(this).find("주차장구분").text() +"</td></tr>";
				info += "<tr><th class='even'>주차장유형 </th><td class='even'>" + $(this).find("주차장유형").text() +"</td></tr>";
				info += "<tr><th>도로명주소 </th><td>" + $(this).find("소재지도로명주소").text() +"</td></tr>";
				info += "<tr><th class='even'>주차구획수 </th><td class='even'>" + $(this).find("주차구획수").text() +"</td></tr>";
/* 				info += "<tr><th>급지구분 </th><td>" + $(this).find("급지구분").text() +"</td></tr>"; */
				info += "<tr><th class='even'>부제시행구분 </th><td class='even'>" + $(this).find("부제시행구분").text() +"</td></tr>";
				info += "<tr><th>운영요일 </th><td>" + $(this).find("운영요일").text() +"</td></tr>";
				info += "<tr><th class='even'>평일운영시간 </th><td class='even'>" + $(this).find("평일운영시작시각").text() +"~" +$(this).find("평일운영종료시각").text() +"</td></tr>";
				info += "<tr><th class='even'>주말운영시간 </th><td class='even'>" + $(this).find("토요일운영시작시각").text() + "~" + $(this).find("토요일운영종료시각").text() +"</td></tr>";
				info += "<tr><th class='even'>공휴일운영시간 </th><td class='even'>" + $(this).find("공휴일운영시작시각").text() + "~" + $(this).find("공휴일운영종료시각").text() +"</td></tr>";
				info += "<tr><th class='even'>요금정보 </th><td class='even'>" + $(this).find("요금정보").text() +"</td></tr>";
				info += "<tr><th>주차기본시간 </th><td>" + $(this).find("주차기본시간").text() +"</td></tr>";
				info += "<tr><th class='even'>주차기본요금 </th><td class='even'>" + $(this).find("주차기본요금").text() +"</td></tr>";
				info += "<tr><th>추가단위시간 </th><td>" + $(this).find("추가단위시간").text() +"</td></tr>";
				info += "<tr><th class='even'>추가단위요금 </th><td class='even'>" + $(this).find("추가단위요금").text() +"</td></tr>";
				info += "<tr><td colspan='2'><a href='https://map.kakao.com/link/to/"+ $(this).find("주차장명").text() +","+ $(this).find("위도").text() +","+ $(this).find("경도").text() +"' target='_blank'>길찾기</a></td></tr>";
				info += "</tbody>";
				info += "<table>";
