...
$(function json()
{
	...
	else
	{
		for (var i = 0; myItem.length; i++) 
		{
			...
			"<a href='SearchDetail.shop?contentid="+myItem[i].contentid + "&contenttypeid="+myItem[i].contenttypeid + "'><h4>" + myItem[i].title + "</h4></a>"
...
<body>
	...
	<form action="InfoSearch.shop" method="get">
	<nav class="blog-pagination justify-content-center d-flex">
		<ul class="pagination">
			<c:if test="${totalCount > 0}">
				<c:if test="${pageNo > 1}">
					<li class="page-item active">
					<a href="InfoTour.shop?arrange=${arrange}&keyword=${keyword}&pageNo=1"
						class="page-link"><<</a></li>
					<c:if test="${pageNo > 1}">
						<li class="page-item active"><a
							href="InfoTour.shop?arrange=${arrange}&keyword=${keyword}&pageNo=${pageNo - 1}"
							class="page-link"><</a></li>
					</c:if>
				</c:if>
				<c:forEach var="a" begin="${startpage}" end="${endpage}">
					...
					<c:if test="${pageNo != a}">
						<li class="page-item active"><a
							href="InfoTour.shop?arrange=${arrange}&keyword=${keyword}&pageNo=${a}"
				...
				<c:if test="${pageNo < maxpage}">
					<li class="page-item active"><a
						...
						class="page-link">></a></li>
					<li class="page-item active"><a
						href="InfoTour.shop?arrange=${arrange}&keyword=${keyword}&pageNo=${maxpage}"
						class="page-link">>></a></li>
				</c:if>
			</c:if>
			<c:if test="${totalCount == 0}">
