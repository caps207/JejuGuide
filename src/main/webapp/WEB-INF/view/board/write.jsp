			...
			<div class="col-lg-8 posts-list">
				...
				<div class="single-post">
					<table class="w3-table w3-striped w3-bordered">
						...
						<tr><td width="10%">첨부파일</td><td><input type="file" name="file"></td></tr>
					</table>
				</div>
				<div class="blog-author">
					<div class="media align-items-center">
						<button type="button" class="button rounded-0 primary-bg text-white w-100 btn_1" onclick="javascript:document.f.submit()">Write</button>
